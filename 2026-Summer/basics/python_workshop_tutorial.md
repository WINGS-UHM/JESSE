...
To write Python, you need a place to type and run code. Your teacher may use an online editor, VS Code, IDLE, Replit, or another tool. A Python file usually ends with `.py`, like `hello.py`.
...
```python
print("Pizza")
print("Favorite song: Here Comes the Sun")
print("Favorite class: Science")
```
...
```python
# This is my first commented program
...
```python
movies = ["Spider-Man", "Moana", "The Lego Movie"]
print(movies[1])
```
...
if age >= 16:
    print("You may be old enough to drive.")
else:
